...
## Conhecimentos
5. Redes de computadores<br />
5.1. Definição<br />
5.2. Redes com fio (cabeada)<br />
5.3. Redes sem fio (wi-fi)<br />

## Material de Apoio
[Introdução a Redes de Computadores](https://github.com/JansenLeite/operlog/blob/main/5_Redes_de_Computadores/OPL_05_01_Arquitetura_de_Redes.pdf)


# Atividade Avaliativa 01 - Redes de Computadores - GRUPO

Considere seus conhecimentos em Redes de Computadores apresentado em aula conforme material de apoio e siga as orientações abaixo:
